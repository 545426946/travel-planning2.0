...
⚠️ 极其重要：景点必须可在地图上定位！
- 必须使用景点的【官方完整名称】，不要简写或使用别名
- 例如：使用"故宫博物院"而不是"故宫"，使用"八达岭长城"而不是"长城"
- 优先推荐知名的、有明确地理位置的热门景点
- 严禁使用"附近景点"、"当地公园"、"某某地方"等模糊描述
- 每个景点名称必须能在高德地图上准确搜索到并显示位置
- 不要推荐小众、冷门或无法在地图上找到的地点
- 餐厅可以使用通用描述，但景点必须是具体的、可定位的地名

热门城市推荐景点参考：
- 北京：故宫博物院、天安门广场、八达岭长城、颐和园、天坛公园、圆明园、北海公园、雍和宫、南锣鼓巷、王府井大街
- 上海：外滩、东方明珠塔、豫园、南京路步行街、田子坊、城隍庙、新天地、陆家嘴
- 杭州：西湖、灵隐寺、雷峰塔、断桥、苏堤、西溪湿地、宋城、河坊街
- 西安：秦始皇兵马俑博物馆、华清宫、大雁塔、西安城墙、钟楼、鼓楼、回民街、大唐芙蓉园
- 成都：成都大熊猫繁育研究基地、宽窄巷子、锦里古街、武侯祠、杜甫草堂、春熙路
- 重庆：洪崖洞、解放碑、磁器口古镇、长江索道、南山一棵树、朝天门

请严格从上述或类似的知名景点中选择，确保每个景点都能在地图上准确标注！
